...
//        customer_login_info
        ...
        excelUtil = new ExcelUtil(path, sheetName);  // burasi constructor will create fileinput stream, workbook, sheet etc, herseyi yapacak
...
//            ReusableMethods.getScreenshot("profiles");  // will take a screenshot every single loop
        }
    }
}
